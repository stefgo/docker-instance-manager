...
/**
 * `config.yaml` next to the agent, unless DIM_CLIENT_CONFIG names another file -- which lets
 * two agents run from one checkout.
 */
export const CONFIG_PATH =
    process.env.DIM_CLIENT_CONFIG?.trim() || path.resolve(ROOT_DIR, "config.yaml");
