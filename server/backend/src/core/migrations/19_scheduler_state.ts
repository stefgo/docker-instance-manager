 ...
 * remember from one run to the next. Written over on every run -- there is no history. What
 * is worth looking back on, a run that failed or was cut short, goes to the activity list.
 *
