...
function readConfig() {
    const ttlDays = parseInt(appConfig.settings.token_retention_days ?? "30", 10);
    const intervalHours = parseInt(appConfig.settings.token_cleanup_interval_hours ?? "24", 10);
    return {
