...
export const StepOutboundDetails = ({ form }: { form: AddClientForm }) => (
    <div className="space-y-6">
        <p className="text-sm text-text-muted">
            ...
            <code className="bg-hover px-1 rounded">docker logs dim-client</code>. Each PIN
            registers once.
        </p>
        ...
        <Input
            ...
            hint="From the agent's log — or the value of DIM_REGISTRATION_SECRET, if the agent was given one."
            required
        />
    </div>
);
