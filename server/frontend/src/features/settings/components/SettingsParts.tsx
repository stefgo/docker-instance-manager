...
/**
 * A whole number, stored as a string like every setting. Every section had this label,
 * field and hint written out by hand, with the clamping repeated in each onChange.
 */
